...
class WeatherService
{
    ...
    public function getWeatherDescription($code): array
    {
        return match (true) {
            ...
            $code == 3 => ['desc' => 'Nuageux', 'icon' => 'wi wi-cloudy'],
            $code == 47 => ['desc' => 'Brouillard', 'icon' => 'wi wi-fog'],
            $code <= 48 => ['desc' => 'Brouillard givré', 'icon' => 'wi wi-fog'],
            $code == 51 => ['desc' => 'bruine légère', 'icon' => 'wi wi-sprinkle'],
            $code == 61 => ['desc' => 'Pluie légère', 'icon' => 'wi wi-rain'],
            $code == 63 => ['desc' => 'Pluie modérée', 'icon' => 'wi wi-rain'],
            $code == 65 => ['desc' => 'fortes pluies', 'icon' => 'wi wi-rain'],
            $code == 80 => ['desc' => 'Averses de pluie', 'icon' => 'wi wi-showers'],
            $code == 81 => ['desc' => 'Averses de pluie modérés', 'icon' => 'wi wi-showers'],
            $code == 95 => ['desc' => 'Tempête', 'icon' => 'wi wi-thunderstorm'],
            $code == 96 => ['desc' => 'Orage avec grêle légère', 'icon' => 'wi wi-thunderstorm'],
            $code == 99 => ['desc' => 'Orage avec grêle', 'icon' => 'wi wi-thunderstorm'],
